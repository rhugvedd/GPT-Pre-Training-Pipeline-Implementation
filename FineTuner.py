...
class FineTuner:
    ...
    def train(self):
        ...
        if self.config.load_check_point:
            ...
            try:
                task1_eval = checkpoint['task1_eval']
            except:
                None

            try:
                task2_eval = checkpoint['task2_eval']
            except:
                None
        ...
        if self.config.fine_tuning_task == TASK_1:
        ...
        elif self.config.fine_tuning_task == TASK_2:
        ...
        for iter in range(st_iter, self.config.num_iters + 1):
            ...
            if (iter % self.config.checkpoint_save_iter == 0) and (iter != 0):
                ...
                torch.save  ({
                                ...
                                'task1_eval': task1_eval,
                                'task2_eval': task2_eval,
